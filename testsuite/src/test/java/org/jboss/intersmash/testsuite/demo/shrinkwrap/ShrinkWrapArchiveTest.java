...
@Slf4j
@Intersmash({
		@Service(ShrinkWrapWildflyImageOpenShiftApplication.class)
})
public class ShrinkWrapArchiveTest {
	@ServiceUrl(ShrinkWrapWildflyImageOpenShiftApplication.class)
	private String appOpenShiftUrl;

	@ServiceProvisioner(ShrinkWrapWildflyImageOpenShiftApplication.class)
